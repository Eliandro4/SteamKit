...
typedef struct CAuthenticationGetPasswordRSAPublicKeyRequest CAuthenticationGetPasswordRSAPublicKeyRequest;
typedef struct CAuthenticationGetPasswordRSAPublicKeyResponse CAuthenticationGetPasswordRSAPublicKeyResponse;
typedef struct CAuthenticationDeviceDetails CAuthenticationDeviceDetails;
typedef struct CAuthenticationBeginAuthSessionViaQRRequest CAuthenticationBeginAuthSessionViaQRRequest;
typedef struct CAuthenticationAllowedConfirmation CAuthenticationAllowedConfirmation;
typedef struct CAuthenticationBeginAuthSessionViaQRResponse CAuthenticationBeginAuthSessionViaQRResponse;
typedef struct CAuthenticationBeginAuthSessionViaCredentialsRequest CAuthenticationBeginAuthSessionViaCredentialsRequest;
typedef struct CAuthenticationBeginAuthSessionViaCredentialsResponse CAuthenticationBeginAuthSessionViaCredentialsResponse;
typedef struct CAuthenticationPollAuthSessionStatusRequest CAuthenticationPollAuthSessionStatusRequest;
typedef struct CAuthenticationPollAuthSessionStatusResponse CAuthenticationPollAuthSessionStatusResponse;
typedef struct CAuthenticationGetAuthSessionInfoRequest CAuthenticationGetAuthSessionInfoRequest;
typedef struct CAuthenticationGetAuthSessionInfoResponse CAuthenticationGetAuthSessionInfoResponse;
typedef struct CAuthenticationGetAuthSessionRiskInfoRequest CAuthenticationGetAuthSessionRiskInfoRequest;
typedef struct CAuthenticationGetAuthSessionRiskInfoResponse CAuthenticationGetAuthSessionRiskInfoResponse;
typedef struct CAuthenticationNotifyRiskQuizResultsNotification CAuthenticationNotifyRiskQuizResultsNotification;
typedef struct CAuthenticationNotifyRiskQuizResultsNotification__RiskQuizResults CAuthenticationNotifyRiskQuizResultsNotification__RiskQuizResults;
typedef struct CAuthenticationUpdateAuthSessionWithMobileConfirmationRequest CAuthenticationUpdateAuthSessionWithMobileConfirmationRequest;
typedef struct CAuthenticationUpdateAuthSessionWithMobileConfirmationResponse CAuthenticationUpdateAuthSessionWithMobileConfirmationResponse;
typedef struct CAuthenticationUpdateAuthSessionWithSteamGuardCodeRequest CAuthenticationUpdateAuthSessionWithSteamGuardCodeRequest;
typedef struct CAuthenticationUpdateAuthSessionWithSteamGuardCodeResponse CAuthenticationUpdateAuthSessionWithSteamGuardCodeResponse;
typedef struct CAuthenticationAccessTokenGenerateForAppRequest CAuthenticationAccessTokenGenerateForAppRequest;
typedef struct CAuthenticationAccessTokenGenerateForAppResponse CAuthenticationAccessTokenGenerateForAppResponse;
typedef struct CAuthenticationRefreshTokenEnumerateRequest CAuthenticationRefreshTokenEnumerateRequest;
typedef struct CAuthenticationRefreshTokenEnumerateResponse CAuthenticationRefreshTokenEnumerateResponse;
typedef struct CAuthenticationRefreshTokenEnumerateResponse__TokenUsageEvent CAuthenticationRefreshTokenEnumerateResponse__TokenUsageEvent;
typedef struct CAuthenticationRefreshTokenEnumerateResponse__RefreshTokenDescription CAuthenticationRefreshTokenEnumerateResponse__RefreshTokenDescription;
typedef struct CAuthenticationGetAuthSessionsForAccountRequest CAuthenticationGetAuthSessionsForAccountRequest;
typedef struct CAuthenticationGetAuthSessionsForAccountResponse CAuthenticationGetAuthSessionsForAccountResponse;
typedef struct CAuthenticationTokenRevokeRequest CAuthenticationTokenRevokeRequest;
typedef struct CAuthenticationTokenRevokeResponse CAuthenticationTokenRevokeResponse;
typedef struct CAuthenticationRefreshTokenRevokeRequest CAuthenticationRefreshTokenRevokeRequest;
typedef struct CAuthenticationRefreshTokenRevokeResponse CAuthenticationRefreshTokenRevokeResponse;
typedef struct CAuthenticationSupportQueryRefreshTokensByAccountRequest CAuthenticationSupportQueryRefreshTokensByAccountRequest;
typedef struct CSupportRefreshTokenDescription CSupportRefreshTokenDescription;
typedef struct CSupportRefreshTokenDescription__TokenUsageEvent CSupportRefreshTokenDescription__TokenUsageEvent;
typedef struct CAuthenticationSupportQueryRefreshTokensByAccountResponse CAuthenticationSupportQueryRefreshTokensByAccountResponse;
typedef struct CAuthenticationSupportQueryRefreshTokenByIDRequest CAuthenticationSupportQueryRefreshTokenByIDRequest;
typedef struct CAuthenticationSupportQueryRefreshTokenByIDResponse CAuthenticationSupportQueryRefreshTokenByIDResponse;
typedef struct CAuthenticationSupportRevokeTokenRequest CAuthenticationSupportRevokeTokenRequest;
typedef struct CAuthenticationSupportRevokeTokenResponse CAuthenticationSupportRevokeTokenResponse;
typedef struct CAuthenticationSupportGetTokenHistoryRequest CAuthenticationSupportGetTokenHistoryRequest;
typedef struct CSupportRefreshTokenAudit CSupportRefreshTokenAudit;
typedef struct CAuthenticationSupportGetTokenHistoryResponse CAuthenticationSupportGetTokenHistoryResponse;
typedef struct CAuthenticationSupportMarkTokenCompromisedRequest CAuthenticationSupportMarkTokenCompromisedRequest;
typedef struct CAuthenticationSupportMarkTokenCompromisedResponse CAuthenticationSupportMarkTokenCompromisedResponse;
typedef struct CCloudGamingCreateNonceRequest CCloudGamingCreateNonceRequest;
typedef struct CCloudGamingCreateNonceResponse CCloudGamingCreateNonceResponse;
typedef struct CCloudGamingGetTimeRemainingRequest CCloudGamingGetTimeRemainingRequest;
typedef struct CCloudGamingTimeRemaining CCloudGamingTimeRemaining;
typedef struct CCloudGamingGetTimeRemainingResponse CCloudGamingGetTimeRemainingResponse;
...
struct  CAuthenticationGetAuthSessionRiskInfoRequest
{
  ProtobufCMessage base;
  protobuf_c_boolean has_client_id;
  uint64_t client_id;
...
struct  CAuthenticationGetAuthSessionRiskInfoResponse
{
  ProtobufCMessage base;
...
struct  CAuthenticationNotifyRiskQuizResultsNotification__RiskQuizResults
{
  ProtobufCMessage base;
...
struct  CAuthenticationNotifyRiskQuizResultsNotification
{
  ProtobufCMessage base;
  protobuf_c_boolean has_client_id;
  uint64_t client_id;
...
{
  ProtobufCMessage base;
  protobuf_c_boolean has_include_revoked;
  protobuf_c_boolean include_revoked;
};
...
struct  CAuthenticationRefreshTokenEnumerateResponse__RefreshTokenDescription
{
  ...
  protobuf_c_boolean has_effective_token_state;
  EAuthTokenState effective_token_state;
};
...
, 0, 0, NULL, 0, 0, 0, EAUTH_TOKEN_PLATFORM_TYPE__k_EAuthTokenPlatformType_Unknown, 0, 0, 0, 0, 0, 0, 0, 0, NULL, NULL, 0, 0, 0, EAUTHENTICATION_TYPE__k_EAuthenticationType_Unknown, 0, EAUTH_TOKEN_STATE__k_EAuthTokenState_Invalid }
...
struct  CAuthenticationSupportMarkTokenCompromisedRequest
{
  ProtobufCMessage base;
  protobuf_c_boolean has_steamid;
  uint64_t steamid;
...
struct  CAuthenticationSupportMarkTokenCompromisedResponse
{
  ProtobufCMessage base;
};
