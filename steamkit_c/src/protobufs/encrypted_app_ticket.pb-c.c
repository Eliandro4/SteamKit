...
{
  static const EncryptedAppTicket init_value = ENCRYPTED_APP_TICKET__INIT;
  *message = init_value;
}
size_t encrypted_app_ticket__get_packed_size
                     (const EncryptedAppTicket *message)
{
  assert(message->base.descriptor == &encrypted_app_ticket__descriptor);
...
const ProtobufCMessageDescriptor encrypted_app_ticket__descriptor =
{
  ...
  (ProtobufCMessageInit) encrypted_app_ticket__init,
