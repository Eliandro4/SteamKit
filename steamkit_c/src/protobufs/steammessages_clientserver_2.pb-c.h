...
typedef struct CMsgClientRichPresenceInfo__KV CMsgClientRichPresenceInfo__KV;
...
typedef struct CMsgClientPendingGameLaunch CMsgClientPendingGameLaunch;
typedef struct CMsgClientPendingGameLaunchResponse CMsgClientPendingGameLaunchResponse;


/* --- enums --- */

typedef enum _CMsgGCClient__EFlag {
  CMSG_GCCLIENT__EFLAG__VALVE_DS = 1
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(CMSG_GCCLIENT__EFLAG)
} CMsgGCClient__EFlag;
...
struct  CMsgClientRichPresenceInfo__KV
{
  ProtobufCMessage base;
  char *key;
  char *value;
};
#define CMSG_CLIENT_RICH_PRESENCE_INFO__KV__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&cmsg_client_rich_presence_info__kv__descriptor) \
, NULL, NULL }
...
struct  CMsgClientRichPresenceInfo__RichPresence
{
  ...
  size_t n_rich_presense;
  CMsgClientRichPresenceInfo__KV **rich_presense;
};
...
struct  CMsgClientGetPeerContentInfo
{
  ...
  protobuf_c_boolean has_client_remote_id;
  uint64_t client_remote_id;
  protobuf_c_boolean has_owned_games_visible;
  protobuf_c_boolean owned_games_visible;
};
...
struct  CMsgClientPendingGameLaunch
{
  ProtobufCMessage base;
  protobuf_c_boolean has_app_id;
  uint32_t app_id;
};
#define CMSG_CLIENT_PENDING_GAME_LAUNCH__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&cmsg_client_pending_game_launch__descriptor) \
, 0, 0 }


struct  CMsgClientPendingGameLaunchResponse
{
  ProtobufCMessage base;
  protobuf_c_boolean has_eresult;
  int32_t eresult;
...
#define CMSG_CLIENT_PENDING_GAME_LAUNCH_RESPONSE__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&cmsg_client_pending_game_launch_response__descriptor) \
, 0, 2, 0, 0, NULL }
...
void   cmsg_client_rich_presence_request__free_unpacked
                     (CMsgClientRichPresenceRequest *message,
                      ProtobufCAllocator *allocator);
/* CMsgClientRichPresenceInfo__KV methods */
...
void   cmsg_client_get_peer_content_info_response__free_unpacked
                     (CMsgClientGetPeerContentInfoResponse *message,
                      ProtobufCAllocator *allocator);
/* CMsgClientPendingGameLaunch methods */
...
void   cmsg_client_pending_game_launch__free_unpacked
                     (CMsgClientPendingGameLaunch *message,
                      ProtobufCAllocator *allocator);
/* CMsgClientPendingGameLaunchResponse methods */
...
typedef void (*CMsgClientRichPresenceRequest_Closure)
                 (const CMsgClientRichPresenceRequest *message,
                  void *closure_data);
typedef void (*CMsgClientRichPresenceInfo__KV_Closure)
                 (const CMsgClientRichPresenceInfo__KV *message,
                  void *closure_data);
...
typedef void (*CMsgClientGetPeerContentInfoResponse_Closure)
                 (const CMsgClientGetPeerContentInfoResponse *message,
                  void *closure_data);
typedef void (*CMsgClientPendingGameLaunch_Closure)
                 (const CMsgClientPendingGameLaunch *message,
                  void *closure_data);
typedef void (*CMsgClientPendingGameLaunchResponse_Closure)
                 (const CMsgClientPendingGameLaunchResponse *message,
                  void *closure_data);
...
extern const ProtobufCMessageDescriptor cmsg_client_rich_presence_info__kv__descriptor;
...
extern const ProtobufCEnumDescriptor    cmsg_gcclient__eflag__descriptor;
...
extern const ProtobufCMessageDescriptor cmsg_client_pending_game_launch__descriptor;
extern const ProtobufCMessageDescriptor cmsg_client_pending_game_launch_response__descriptor;
